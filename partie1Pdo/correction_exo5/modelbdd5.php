...
class database { //declaration class 
    ...
    public function __construct() { //methode magique construct permet d'executer ce qu'il y a ds le construct et permet d'executer le destruct a la fin a la fin de l'instantion
        try {
            $this->database = new PDO('mysql:host=localhost;dbname=colyseum;charset=utf8', 'victoriac', '1Travail'); //instancie un nouvel objet; permet la connexion a ma base de donnée.
